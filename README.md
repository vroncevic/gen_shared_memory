...
|------|-------|------|-------|
| `gen_shared_memory/__init__.py` | 69 | 10 | 86%|
| `gen_shared_memory/pro/__init__.py` | 57 | 0 | 100%|
| `gen_shared_memory/pro/read_template.py` | 51 | 0 | 100%|
| `gen_shared_memory/pro/write_template.py` | 52 | 1 | 98%|
| **Total** | 229 | 11 | 95% |
