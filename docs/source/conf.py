...
project: str = 'gen_shared_memory'
project_copyright: str = '2026, Vladimir Roncevic <elektron.ronca@gmail.com>'
author: str = 'Vladimir Roncevic <elektron.ronca@gmail.com>'
version: str = '2.0.0'
release: str = 'https://github.com/vroncevic/gen_shared_memory/releases'
...
htmlhelp_basename: str = 'gen_shared_memorydoc'
latex_elements: dict[object, object] = {}
latex_documents: list[tuple[object, ...]] = [(
    root_doc, 'gen_shared_memory.tex', 'gen_shared_memory Documentation',
    'Vladimir Roncevic \\textless{}elektron.ronca@gmail.com\\textgreater{}',
    'manual'
)]
man_pages: list[tuple[object, ...]] = [(
    root_doc, 'gen_shared_memory', 'gen_shared_memory Documentation', [author], 1
)]
texinfo_documents: list[tuple[object, ...]] = [(
    root_doc, 'gen_shared_memory', 'gen_shared_memory Documentation', author,
    'gen_shared_memory', 'One line description of project.', 'Miscellaneous'
)]
