...
class SHMSetup(object):
    """
        Define class SHMSetup with attribute(s) and method(s).
        ...
        It defines:
            ...
            method:
                ...
                gen_shm_setup - Generate project skeleton
    """
    ...
    def __init__(self, verbose=False):
        """
            ...
            :exceptions: None
        """
        verbose_message(SHMSetup.VERBOSE, verbose, 'Initial setup')
        pass

    def gen_shm_setup(self, project_name, verbose=False):
        """
