...
Info
    Main entry point for Shared Memory Generator CLI.
'''
...
def main() -> bool:
    '''
        Bootstraps and runs the gen_shared_memory with required adapters.

        :return: True if successful, False otherwise.
        :exceptions: None
    '''
    gen_shared_memory: GenSharedMemory = GenSharedMemory(
        GenSharedMemoryBundleFactory.create_bundle()
    )

    return gen_shared_memory.process()


if __name__ == '__main__':
    '''
        Entry point for gen_shared_memory execution.
