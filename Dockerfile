...
RUN mkdir /gen_shared_memory/
COPY gen_shared_memory /gen_shared_memory/
COPY setup.py /
COPY README.md /
RUN find /gen_shared_memory/ -name "*.editorconfig" -type f -exec rm -Rf {} \;
