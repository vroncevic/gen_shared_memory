...
Info
    Defines GenSharedMemoryCommandDefinition class.
'''
...
class GenSharedMemoryCommandDefinition:
    '''
        CLI subcommand metadata definition for shared memory project generation.
    ...
    def help_text(self) -> str:
        ...
        '''
        return 'Generate shared memory project files'
    ...
    def options(self) -> Sequence[OptionData]:
        ...
        return [
            OptionData(
                name="--name",
                help_text="Shared memory project name",
                action=None,
                default="myshm",
                required=True,
                choices=None,
