...
Info
    A validator for the gen_shared_memory bundle.
'''
...
class GenSharedMemoryBundleValidator:
    '''
        A validator for the gen_shared_memory bundle.
        ...
        It defines:
            ...
            :methods:
                | validate - Validates the gen_shared_memory bundle.
                | is_valid - Checks if the gen_shared_memory bundle is valid.
    '''

    @classmethod
    def validate(cls, bundle: GenSharedMemoryBundle) -> None:
        '''
            Validates the gen_shared_memory bundle.

            :param bundle: The gen_shared_memory bundle to be validated.
            :exceptions:
        ...
        '''
        ctx: str = 'gen_shared_memory_bundle_validator::validate(...)'
        msg_bundle_none: str = 'the gen_shared_memory bundle must be provided'
        msg_bundle_istype: str = 'the gen_shared_memory bundle must be an instance of GenSharedMemoryBundle'
        ...
        istype(bundle, GenSharedMemoryBundle, ctx, msg_bundle_istype)
    ...
    @classmethod
    def is_valid(cls, bundle: GenSharedMemoryBundle) -> bool:
        '''
            Checks if the gen_shared_memory bundle is valid.

            :param bundle: The gen_shared_memory bundle to be checked.
