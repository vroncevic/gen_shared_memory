...
Info
    GenSharedMemory bundle options for the gen_shared_memory bundle.
'''
...
class GenSharedMemoryBundleOptions(TypedDict):
    '''
        GenSharedMemory bundle options for the gen_shared_memory bundle.
        ...
        It defines:
            ...
            :attributes:
                | info_file - The info file path for the gen_shared_memory bundle.
    '''
