...
Info
    Validator for the gen_shared_memory bundle dependencies.
'''
...
class GenSharedMemoryBundleDependenciesValidator:
    '''
        Validator for the gen_shared_memory bundle dependencies.
        ...
        It defines:
            ...
            :methods:
                | validate - Validates the gen_shared_memory bundle dependencies.
                | is_valid - Checks if the gen_shared_memory bundle dependencies is valid.
    '''

    @classmethod
    def validate(cls, dependencies: GenSharedMemoryBundleDependencies) -> None:
        '''
            Validates the gen_shared_memory bundle dependencies.

            :param dependencies: The gen_shared_memory bundle dependencies to be validated.
            :exceptions:
        ...
        '''
        ctx: str = 'gen_shared_memory_bundle_dependencies_validator::validate(...)'
        msg_dependencies_none: str = 'the gen_shared_memory bundle dependencies must be provided'
        msg_dependencies_istype: str = 'the gen_shared_memory bundle dependencies must be a Mapping'

        not_none(dependencies, ctx, msg_dependencies_none)
        istype(dependencies, Mapping, ctx, msg_dependencies_istype)

        for attr_name, expected_type in GenSharedMemoryBundleKeys.get_dependency_to_type().items():
    ...
    @classmethod
    def is_valid(cls, dependencies: GenSharedMemoryBundleDependencies) -> bool:
        '''
            Checks if the gen_shared_memory bundle dependencies is valid.

            :param dependencies: The gen_shared_memory bundle dependencies to be checked.
