...
Info
    GenSharedMemory bundle dependencies for the gen_shared_memory bundle.
'''
...
class GenSharedMemoryBundleDependencies(TypedDict):
    '''
        GenSharedMemory bundle dependencies for the gen_shared_memory bundle.
        ...
        It defines:
            ...
            :attributes:
                | base - The base bundle with the base components for the gen_shared_memory bundle.
                | service - The service orchestrating the gen_shared_memory's execution for the gen_shared_memory bundle.
                | subprocessor - The adapter executing the gen_shared_memory's sub-processes for the gen_shared_memory bundle.
                | cli - The command-line interface adapter for the gen_shared_memory bundle.
    '''
