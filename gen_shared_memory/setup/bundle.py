...
Info
    Defines the gen_shared_memory bundle.
'''
...
class GenSharedMemoryBundle:
    '''
        GenSharedMemory bundle holding the components of the gen_shared_memory.

        It defines:

            :attributes:
                | base - The base bundle with the base components.
                | service - The service orchestrating the gen_shared_memory's execution.
                | subprocessor - The adapter executing the gen_shared_memory's sub-processes.
                | cli - The command-line interface adapter.
            :methods:
                | to_dict - Converts the gen_shared_memory bundle to a dictionary.
    '''
    ...
    def to_dict(self) -> dict[str, object]:
        '''
            Converts the gen_shared_memory bundle to a dictionary.

            :return: Dictionary representation of the gen_shared_memory bundle.
            :exceptions: None.
        '''
