...
Info
    Validator for the gen_shared_memory bundle options.
'''
...
class GenSharedMemoryBundleOptionsValidator:
    '''
        Validator for the gen_shared_memory bundle options.
        ...
        It defines:
            ...
            :methods:
                | validate - Validates the gen_shared_memory bundle options.
                | is_valid - Checks if the gen_shared_memory bundle options is valid.
    '''

    @classmethod
    def validate(cls, options: GenSharedMemoryBundleOptions) -> None:
        '''
            Validates the gen_shared_memory bundle options.

            :param options: The gen_shared_memory bundle options to be validated.
            :exceptions:
        ...
        '''
        ctx: str = 'gen_shared_memory_bundle_options_validator::validate(...)'
        msg_options_none: str = 'the gen_shared_memory bundle options must be provided'
        msg_options_istype: str = 'the gen_shared_memory bundle options must be a Mapping'

        not_none(options, ctx, msg_options_none)
        istype(options, Mapping, ctx, msg_options_istype)

        for attr_name, expected_type in GenSharedMemoryBundleKeys.get_option_to_type().items():
    ...
    @classmethod
    def is_valid(cls, options: GenSharedMemoryBundleOptions) -> bool:
        '''
            Checks if the gen_shared_memory bundle options is valid.

            :param options: The gen_shared_memory bundle options to be checked.
